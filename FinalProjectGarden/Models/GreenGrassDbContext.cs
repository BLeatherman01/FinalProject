...
public partial class GreenGrassDbContext : DbContext
{
    ...
    public virtual DbSet<MyGardensss> MyGardenssses { get; set; }

    public virtual DbSet<RecentPlant> RecentPlants { get; set; }

    public virtual DbSet<RecentPlantse> RecentPlantses { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MyGardensss>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__MyGarden__3214EC07D3FB6DEA");

            entity.ToTable("MyGardensss");
            ...
            entity.HasOne(d => d.Garden).WithMany(p => p.MyGardenssses)
                .HasForeignKey(d => d.GardenId)
        ...
        modelBuilder.Entity<RecentPlantse>(entity =>
        {
            ...
            entity.HasOne(d => d.RecentIdsNavigation).WithMany(p => p.RecentPlantses)
